...
\newcommand{\widerule}{
  \moveleft\hoffset\vbox{
    \hrule width\resumewidth height 0.1pt
  }
}
\newcommand{\sectionspace}{\vspace{10pt}}
\renewcommand{\labelitemi}{\fontspec[Color=HeaderColor]\scriptsize\ding{93}}
...
\moveleft\hoffset\vbox{
  \fontsize{42}{42}
    \fontspec[Color=HeaderColor]{Bello Pro}\textbf{
      Phillip Thomas Ridlen
     } \\
  \fontsize{20}{20} \smallskip \\
    \fontspec[Color=MainColor]{Proxima Nova Thin}
  ...
  \begin{tabular}{l@{\hspace{.80in}}l@{\hspace{.7in}}l@{\hspace{.8in}}l@{\hspace{.50in}}l}
    \textbf{Address:} & 5008 Lincoln Oaks Drive North  & \textbf{Telephone:} & +16825579480 \\
                      ...
                      & Fort Worth, Texas 76132 &
                        \textbf{Website:} & http://phillipridlen.com\\ & & & http://github.com/philtr
  \end{tabular}}
...
\section{\fontspec[Color=MainColor]{Proxima Nova}
  Skills
                ...
                \textbf{Development:}
                  Ruby/Rails, PHP, MySQL/PostgreSQL, Javascript/jQuery, Git \\
              
                \textbf{Design:}
                  HTML, CSS, Photoshop, Illustrator \\
              
                \textbf{Office:}
                  Apple iWork, Microsoft Office, \LaTeX, Typing Speed: 60-80 wpm 
