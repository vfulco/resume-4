...
\section{\textsf{Relevant \\ Experience}}
                ...
                \textbf{\textit{Diverse Suspension Technologies}
                 at \textsc{Balcom Agency} in Stephenville, Texas\dotfill 2009--2010}
                 \vspace{-10pt}\begin{itemize} \itemsep -2pt %reduce space between items 
                ...
                \textbf{\textit{Freelance Design and Development}
                 at \textsc{Balcom Agency} in Burleson, Texas\dotfill 2003--2010}
                 \vspace{-10pt}\begin{itemize} \itemsep -2pt %reduce space between items 
                ...
                \textbf{\textit{Ball Corporation}
                 at \textsc{Balcom Agency} in Fort Worth, Texas\dotfill 2007--2009}
                 \vspace{-10pt}\begin{itemize} \itemsep -2pt %reduce space between items 
