...
% Center the name over the entire width of resume:{
 % \moveleft.5\hoffset\centerline{\LARGE\textbf{ Phillip T. Ridlen}}
...
% Again, the address lines must be centered over entire width of resume:
 \moveleft1.06\hoffset\vbox { \sffamily
  \begin{tabular}{l@{\hspace{.70in}}l@{\hspace{.5in}}|@{\hspace{.3in}}l@{\hspace{.70in}}l}
    \textbf{\textsf{Address:}}  & 2340 Trail Tree Ct & \textbf{\textsf{Telephone:}} & (682) 233-3232 \\
  ...
  \moveleft\hoffset\vbox{\hrule width\resumewidth height 0.1pt}\setstretch{1}%\smallskip
